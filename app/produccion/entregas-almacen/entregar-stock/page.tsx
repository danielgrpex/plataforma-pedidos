...
export default function EntregarStockPage() {
  ...
  const submit = async () => {
    ...
    const res = await fetch("/api/inventario/entrada-stock", {
      ...
      body: JSON.stringify({
        ...
        // opcional: si quieres rastrear por algo
    ...
    setNota("");
    setInventarioIdBase("");
    // recarga para seguir trabajando
    await load();
  };
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-neutral-600">
              Registra sobrantes como <span className="font-medium">Disponible</span> (crea/usa lote Stock y agrega movimiento).
            </p>
          </div>
        ...
        <div className="mb-4 rounded-2xl bg-white shadow-sm ring-1 ring-black/5 p-4">
          <div className="grid gap-3 md:grid-cols-2">
            ...
            <div>
              ...
              />
              <p className="mt-1 text-xs text-neutral-500">Debe coincidir con la columna “almacen” de Inventario.</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-2xl bg-white shadow-sm ring-1 ring-black/5 p-5">
          <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div className="w-full md:max-w-xl">
              ...
              <p className="mt-1 text-xs text-neutral-500">
                Fuente: hoja <span className="font-medium">Inventario</span> (solo disponibles).
              </p>
            </div>
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            <div>
              ...
              <select
                value={inventarioIdBase}
                onChange={(e) => setInventarioIdBase(e.target.value)}
                className={inputCls}
              >
                <option value="">Selecciona…</option>
                {items.map((it) => (
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  value={cantidadUnd}
                  onChange={(e) => setCantidadUnd(e.target.value)}
                  className={inputCls}
                  placeholder="Ej: 5"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className={inputCls}
                  placeholder='Ej: "Sobrante OPE260001"'
                />
              </div>
